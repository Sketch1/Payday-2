...
public class Interface extends javax.swing.JFrame {
    ...
    private void goButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_goButtonActionPerformed
        ...
        It sets up the number of Players and months, and runs startGame.*/
        ...
        startGame(); //Idea: is StartGame redundant? Could it just continue from here?
    ...
    public void allPayersPlay(int i) { /*This method causes all Players to pay a
        passed amount.*/
        for (int index = 0; index < noOfPlayers; index++) {
